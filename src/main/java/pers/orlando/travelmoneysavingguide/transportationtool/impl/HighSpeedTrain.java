 ...
 * Author: liujiacheng
 */
public class HighSpeedTrain extends TransportationTool {
    public static String name="高铁";

    public HighSpeedTrain(String id,double consumeTime, double price) {
        super(id,name,consumeTime,price);
    }

    static public TransportationTool createTemp() {
        return new HighSpeedTrain("NULL",0,0);
    }
}
